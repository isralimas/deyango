...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Receta.clavemateriaprima'
        db.delete_column(u'app_receta', 'clavemateriaprima_id')

        # Adding M2M table for field clavemateriaprima on 'Receta'
        m2m_table_name = db.shorten_name(u'app_receta_clavemateriaprima')
        ...
        db.create_unique(m2m_table_name, ['receta_id', 'materiaprima_id'])


    def backwards(self, orm):
        # Adding field 'Receta.clavemateriaprima'
        db.add_column(u'app_receta', 'clavemateriaprima',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['app.MateriaPrima']),
                      keep_default=False)

        # Removing M2M table for field clavemateriaprima on 'Receta'
        db.delete_table(db.shorten_name(u'app_receta_clavemateriaprima'))
    ...
    models = {
        ...
        u'app.proveedore': {
            ...
            'productos': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['app.Producto']", 'symmetrical': 'False'}),
