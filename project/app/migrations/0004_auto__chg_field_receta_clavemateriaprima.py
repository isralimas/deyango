...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Receta.clavemateriaprima'
        db.alter_column(u'app_receta', 'clavemateriaprima_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.MateriaPrima']))
